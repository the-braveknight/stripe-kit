...
public enum StripeSourceAllowRedisplay: String, Codable, Sendable {
...
public struct StripeSourceOrder: Codable, Sendable {
...
public struct StripeSourceOrderItem: Codable, Sendable {
...
public enum StripeSourceOrderItemType: String, Codable, Sendable {
    case sku
    case tax
    case shipping
}

public struct StripeSourceOrderShipping: Codable, Sendable {
    /// Shipping address.
    public var address: Address?
...
public struct StripeSourceKlarna: Codable, Sendable {
