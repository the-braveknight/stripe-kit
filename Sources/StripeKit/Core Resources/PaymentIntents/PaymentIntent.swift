...
public struct PaymentIntentPaymentMethodConfigurationDetails: Codable, Sendable {
...
public struct PaymentIntentPresentmentDetails: Codable, Sendable {
...
public enum PaymentIntentAutomaticPaymentMethodsAllowRedirects: String, Codable, Sendable {
...
public struct PaymentIntentAmountDetailsShipping: Codable, Sendable {
...
public struct PaymentIntentAmountDetailsTax: Codable, Sendable {
