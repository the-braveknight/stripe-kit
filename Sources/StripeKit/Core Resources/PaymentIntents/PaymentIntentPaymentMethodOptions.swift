...
// MARK: - CashApp
public struct PaymentIntentPaymentMethodOptionsCashApp: Codable, Sendable {
    /// Controls when the funds will be captured from the customer’s account.
...
public enum PaymentIntentPaymentMethodOptionsCashAppCaptureMethod: String, Codable, Sendable {
    /// Use manual if you intend to place the funds on hold and want to override the top-level `capture_method` value for this payment method.
    case manual
}

public enum PaymentIntentPaymentMethodOptionsCashAppSetupFutureUsage: String, Codable, Sendable {
    /// Use `on_session` if you intend to only reuse the payment method when your customer is present in your checkout flow.
    case onSession = "on_session"
    /// Use `off_session` if your customer may or may not be present in your checkout flow.
    case offSession = "off_session"
...
// MARK: - Paypal
public struct PaymentIntentPaymentMethodOptionsPaypal: Codable, Sendable {
    /// Controls when the funds will be captured from the customer’s account.
...
public enum PaymentIntentPaymentMethodOptionsPaypalCaptureMethod: String, Codable, Sendable {
    /// Use manual if you intend to place the funds on hold and want to override the top-level `capture_method` value for this payment method.
    case manual
}

public enum PaymentIntentPaymentMethodOptionsPaypalSetupFutureUsage: String, Codable, Sendable {
    /// Use `off_session` if your customer may or may not be present in your checkout flow.
    case offSession = "off_session"
    /// Use `none` if you do not intend to reuse this payment method and want to override the top-level `setup_future_usage` value for this payment method.
    case `none`
