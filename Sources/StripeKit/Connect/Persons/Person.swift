...
public struct PersonAdditionalTosAcceptancesAccount: Codable, Sendable {
...
public struct PersonUSCFPBDataEthnicityDetails: Codable, Sendable {
...
public struct PersonUSCFPBDataRaceDetails: Codable, Sendable {
    /// The persons race.
