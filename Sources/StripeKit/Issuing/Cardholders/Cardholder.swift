...
public enum CardholderPreferredLocale: String, Codable, Sendable {
    case da
    case de
    case en
    case es
...
public struct CardholderRedaction: Codable, Sendable {
...
public enum CardholderRedactionStatus: String, Codable, Sendable {
