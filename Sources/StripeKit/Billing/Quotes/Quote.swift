...
public struct Quote: Codable, Sendable {
    ...
    /// The account (if any) for which the funds of the quote are intended. The customer's account is required before finalizing the quote. Once specified, it cannot be changed.
...
public struct QuoteAutomaticTax: Codable, Sendable {
    ...
    public var liability: QuoteAutomaticTaxLiability?
    ...
    public init(enabled: Bool,
                liability: QuoteAutomaticTaxLiability? = nil,
                provider: String? = nil,
                status: QuoteAutomaticTaxStatus? = nil) {
...
public struct QuoteAutomaticTaxLiability: Codable, Sendable {
    /// The connected account being referenced when `type` is `account`.
    @Expandable<ConnectAccount> public var account: String?
    /// Type of the account referenced.
    public var type: QuoteAutomaticTaxLiabilityType?

    public init(account: String? = nil, type: QuoteAutomaticTaxLiabilityType? = nil) {
        self._account = Expandable(id: account)
        self.type = type
    }
}

public enum QuoteAutomaticTaxLiabilityType: String, Codable, Sendable {
    /// Indicates that the connected account is liable for tax.
    case account
    /// Indicates that the account making the API call is liable for tax.
    case `self`
}
...
public struct QuoteInvoiceSettings: Codable, Sendable {
    ...
    public var issuer: QuoteInvoiceSettingsIssuer?

    public init(daysUntilDue: Int? = nil, issuer: QuoteInvoiceSettingsIssuer? = nil) {
        self.daysUntilDue = daysUntilDue
        self.issuer = issuer
    }
}

public struct QuoteInvoiceSettingsIssuer: Codable, Sendable {
    /// The connected account being referenced when `type` is `account`.
    @Expandable<ConnectAccount> public var account: String?
    /// Type of the account referenced.
    public var type: QuoteInvoiceSettingsIssuerType?

    public init(account: String? = nil, type: QuoteInvoiceSettingsIssuerType? = nil) {
        self._account = Expandable(id: account)
        self.type = type
    }
}

public enum QuoteInvoiceSettingsIssuerType: String, Codable, Sendable {
    /// Indicates that the connected account issues the invoice.
    case account
    /// Indicates that the account making the API call issues the invoice.
    case `self`
}
...
public struct QuoteSubscriptionData: Codable, Sendable {
    ...
    /// The billing mode of the subscription that will be created from the quote.
    public var billingMode: QuoteSubscriptionDataBillingMode?
    ...
    public init(description: String? = nil,
                ...
                billingMode: QuoteSubscriptionDataBillingMode? = nil,
                metadata: [String: String]? = nil,
...
public struct QuoteSubscriptionDataBillingMode: Codable, Sendable {
    /// Controls the calculation and orchestration of prorations and invoices for subscriptions.
    public var type: QuoteSubscriptionDataBillingModeType?
    /// Configure behavior for flexible billing mode.
    public var flexible: QuoteSubscriptionDataBillingModeFlexible?

    public init(type: QuoteSubscriptionDataBillingModeType? = nil,
                flexible: QuoteSubscriptionDataBillingModeFlexible? = nil) {
        self.type = type
        self.flexible = flexible
    }
}

public enum QuoteSubscriptionDataBillingModeType: String, Codable, Sendable {
...
public struct QuoteSubscriptionDataBillingModeFlexible: Codable, Sendable {
    /// Controls how invoices and invoice items display proration amounts and discount amounts.
    public var prorationDiscounts: QuoteSubscriptionDataBillingModeFlexibleProrationDiscounts?

    public init(prorationDiscounts: QuoteSubscriptionDataBillingModeFlexibleProrationDiscounts? = nil) {
        self.prorationDiscounts = prorationDiscounts
    }
}

public enum QuoteSubscriptionDataBillingModeFlexibleProrationDiscounts: String, Codable, Sendable {
    /// Discount amounts are included in proration line items.
    case included
    /// Discount amounts are itemized as separate line items.
    case itemized
}
