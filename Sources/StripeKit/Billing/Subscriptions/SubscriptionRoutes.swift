...
public protocol SubscriptionRoutes: StripeAPIRoute {
    ...
    ///   - billingMode: Controls how prorations and invoices for subscriptions are calculated and orchestrated. Cannot be updated after the subscription is created.
